...
const expenseController = {
  ...
  createExpense: async (req, res) => {
    try {
      let { name, amount, date, category_id, detail, payment_method, category } = req.body;
      ...
      // Debug log
      logger.info('Creating expense', { name, amount, date, category_id });
  ...
  getAllExpenses: async (req, res) => {
    try {
      ...
      console.log('woow this is page -=>>> ',page);
