...
import { PieChart, Pie, Cell, ResponsiveContainer, BarChart, Bar, XAxis, YAxis, Area, AreaChart } from 'recharts';
    ...
    <div className="flex flex-col items-center relative flex-1">
      <div className="w-32 h-32 sm:w-36 sm:h-36 lg:w-44 lg:h-44 relative mb-3">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center z-10">
          ...
          <div className={`text-lg sm:text-xl lg:text-2xl font-extrabold leading-none mb-1 tracking-tight ${isNegative ? 'text-red-500' : 'text-slate-800'}`}>
